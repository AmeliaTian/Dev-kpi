...
/**
 * @Description 02指标评分细则 Controller
 ...
 */
@RestController
@Api(tags="BASE_'02指标评分细则'",description = "'02指标评分细则'增删改查api")
public class Jx02ZbpfxzInfoCtl {

    @Resource(name = "jx02ZbpfxzInfoService")
    private IJx02ZbpfxzInfoService jx02ZbpfxzInfoService;

    @ApiOperation(value = "查询'02指标评分细则'记录数", notes = "根据传入参数查询'02指标评分细则'记录数,输入参数参照类Jx02ZbpfxzInfoVO")
    @RequestMapping(value = "/kpi/jx02ZbpfxzInfo", method = RequestMethod.HEAD)
    public HttpOutMsgBean count(HttpServletRequest request) {
        ...
        Long dataLen = jx02ZbpfxzInfoService.countEntity(paramMap);
    ...
    @ApiOperation(value = "查询'02指标评分细则'", notes = "##### 根据传入参数查询'02指标评分细则'，参数名称参照Jx02ZbpfxzInfoVO中的属性名，可通过添加后缀来实现‘等于’、‘大于’、‘LIKE’等操作。具体如下：\n" +
    ...
    @ApiImplicitParams({
        @ApiImplicitParam(name = "Jx02ZbpfxzInfoVO.*", value = "Jx02ZbpfxzInfoVO实体中相关属性名", dataType = "*", paramType = "query"),
    ...
    @RequestMapping(value = "/kpi/jx02ZbpfxzInfo", method = RequestMethod.GET)
    public HttpOutMsgBean query(HttpServletRequest request,@RequestParam(value = "page",required = false) Integer page, @RequestParam(value = "size",required = false) Integer size, @RequestParam(value = "sort",required = false) String sort) {
        ...
        Iterable<Jx02ZbpfxzInfoVO> queryResult =  jx02ZbpfxzInfoService.queryEntity(paramMap, pageable);
...
/*如果可编辑(table)，则生成下边的更新操作*/
    @ApiOperation(value = "新增'02指标评分细则'", notes = "批量新增,输入参数为Jx02ZbpfxzInfoVO的列表")
    @RequestMapping(value = "/kpi/jx02ZbpfxzInfo", method = RequestMethod.POST)
    public HttpOutMsgBean save(@RequestBody List<Jx02ZbpfxzInfoVO> jx02ZbpfxzInfoVOS) {
        Integer saveRows = jx02ZbpfxzInfoService.saveEntity(jx02ZbpfxzInfoVOS);
    ...
    @ApiOperation(value = "更新'02指标评分细则'", notes = "批量更新,输入参数为Jx02ZbpfxzInfoVO的列表")
    @RequestMapping(value = "/kpi/jx02ZbpfxzInfo", method = RequestMethod.PUT)
    public HttpOutMsgBean update(@RequestBody List<Jx02ZbpfxzInfoVO> jx02ZbpfxzInfoVOS) {
        //如果有ID为空，则不更新
        for (Jx02ZbpfxzInfoVO vo : jx02ZbpfxzInfoVOS) {
        ...
        Integer saveRows =  jx02ZbpfxzInfoService.updateEntity(jx02ZbpfxzInfoVOS);
    ...
    @ApiOperation(value = "删除'02指标评分细则'", notes = "批量删除，传入参数为对应记录ID列表")
    @RequestMapping(value = "/kpi/jx02ZbpfxzInfo", method = RequestMethod.DELETE)
    public HttpOutMsgBean remove(@RequestBody List<String> ids) {
        Integer delRows =  jx02ZbpfxzInfoService.removeEntity(ids);
