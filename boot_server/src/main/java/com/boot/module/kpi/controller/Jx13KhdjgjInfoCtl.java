...
/**
 * @Description 13考核等级系数管理表 Controller
 ...
 */
@RestController
@Api(tags="BASE_'13考核等级系数管理表'",description = "'13考核等级系数管理表'增删改查api")
public class Jx13KhdjgjInfoCtl {

    @Resource(name = "jx13KhdjgjInfoService")
    private IJx13KhdjgjInfoService jx13KhdjgjInfoService;

    @ApiOperation(value = "查询'13考核等级系数管理表'记录数", notes = "根据传入参数查询'13考核等级系数管理表'记录数,输入参数参照类Jx13KhdjgjInfoVO")
    @RequestMapping(value = "/kpi/jx13KhdjgjInfo", method = RequestMethod.HEAD)
    public HttpOutMsgBean count(HttpServletRequest request) {
        ...
        Long dataLen = jx13KhdjgjInfoService.countEntity(paramMap);
    ...
    @ApiOperation(value = "查询'13考核等级系数管理表'", notes = "##### 根据传入参数查询'13考核等级系数管理表'，参数名称参照Jx13KhdjgjInfoVO中的属性名，可通过添加后缀来实现‘等于’、‘大于’、‘LIKE’等操作。具体如下：\n" +
    ...
    @ApiImplicitParams({
        @ApiImplicitParam(name = "Jx13KhdjgjInfoVO.*", value = "Jx13KhdjgjInfoVO实体中相关属性名", dataType = "*", paramType = "query"),
    ...
    @RequestMapping(value = "/kpi/jx13KhdjgjInfo", method = RequestMethod.GET)
    public HttpOutMsgBean query(HttpServletRequest request,@RequestParam(value = "page",required = false) Integer page, @RequestParam(value = "size",required = false) Integer size, @RequestParam(value = "sort",required = false) String sort) {
        ...
        Iterable<Jx13KhdjgjInfoVO> queryResult =  jx13KhdjgjInfoService.queryEntity(paramMap, pageable);
...
/*如果可编辑(table)，则生成下边的更新操作*/
    @ApiOperation(value = "新增'13考核等级系数管理表'", notes = "批量新增,输入参数为Jx13KhdjgjInfoVO的列表")
    @RequestMapping(value = "/kpi/jx13KhdjgjInfo", method = RequestMethod.POST)
    public HttpOutMsgBean save(@RequestBody List<Jx13KhdjgjInfoVO> jx13KhdjgjInfoVOS) {
        Integer saveRows = jx13KhdjgjInfoService.saveEntity(jx13KhdjgjInfoVOS);
    ...
    @ApiOperation(value = "更新'13考核等级系数管理表'", notes = "批量更新,输入参数为Jx13KhdjgjInfoVO的列表")
    @RequestMapping(value = "/kpi/jx13KhdjgjInfo", method = RequestMethod.PUT)
    public HttpOutMsgBean update(@RequestBody List<Jx13KhdjgjInfoVO> jx13KhdjgjInfoVOS) {
        //如果有ID为空，则不更新
        for (Jx13KhdjgjInfoVO vo : jx13KhdjgjInfoVOS) {
        ...
        Integer saveRows =  jx13KhdjgjInfoService.updateEntity(jx13KhdjgjInfoVOS);
    ...
    @ApiOperation(value = "删除'13考核等级系数管理表'", notes = "批量删除，传入参数为对应记录ID列表")
    @RequestMapping(value = "/kpi/jx13KhdjgjInfo", method = RequestMethod.DELETE)
    public HttpOutMsgBean remove(@RequestBody List<String> ids) {
        Integer delRows =  jx13KhdjgjInfoService.removeEntity(ids);
