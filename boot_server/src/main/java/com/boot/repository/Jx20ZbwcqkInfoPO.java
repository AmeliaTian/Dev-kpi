...
@DynamicInsert
@DynamicUpdate
@Table(name = "JX20_ZBWCQK_INFO")
@EntityListeners(AuditingEntityListener.class)
public class Jx20ZbwcqkInfoPO implements java.io.Serializable {
    ...
    /** 考核年份 */
    @Column(name = "KHNF", nullable = true, length = 200)
    private String khnf;

    /** 算法明细id   02表 */
    @Column(name = "SFMXID", nullable = true, length = 20)
    private String sfmxid;

    /** 明细完成情况 */
    @Column(name = "MXWCQK", nullable = true, length = 2000)
